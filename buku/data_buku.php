...
$no = 1;
$data = mysqli_query($koneksi,"select * from buku order by id");
$jumlah_data = mysqli_num_rows($data);
$total_halaman = ceil($jumlah_data / $batas);

if(isset($_POST["cari"])){
    $search = $_POST['keyword'];
    $data_buku = mysqli_query($koneksi,"select * from buku WHERE nama LIKE '%$search%' limit $halaman_awal, $batas");
} else {
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead class="bg-secondary">
                              ...
                              <tbody>
                                ...
                                <?php 
                                while($d = mysqli_fetch_assoc($data_buku)) {
                                ?>
                                    <tr>
