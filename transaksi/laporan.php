    ...
    <div class="row g-0 mt-5 content">
        ...
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ms-3 mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="./data_transaksi_pinjam.php">
                    <i class="fas fa-sign-in-alt me-2"></i>Transaksi Pinjam
                    </a>
                    <hr class="bg-secondary ms-2" size="4px">
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="./data_transaksi_kembali.php">
                    ...
                    <div class="card-body g-0">
                        <div class="row g-0">
                            ...
                            <div class="col-md-2 g-0 d-flex justify-content-end align-items-center">
                                <a href="cetak.php" target="_BLANK"><i class="fas fa-print fa-3x me-3 icon-plus text-white"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
