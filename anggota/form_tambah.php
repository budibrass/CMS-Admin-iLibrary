                    ...
                    <div class="card-body">
                        <form action="tambah_aksi.php" method="POST" >
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input required type="text" class="form-control form-control-sm input-edit" name="nama" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="text" class="form-control form-control-sm input-edit" name="pekerjaan" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select required class="form-select form-select-sm input-edit" name="jk" aria-label="Default select example">
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select required class="form-select form-select-sm input-edit" name="agama" aria-label="Default select example">
                                                <option disabled selected>Pilih Salah Satu</option>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input required type="text" name="hp" class="form-control form-control-sm input-edit" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select required class="form-select form-select-sm" name="status" aria-label="Default select example" placeholder="test">
                                                <option disabled selected>Pilih Salah Satu</option>
                                ...
                                <div class="col-md-4">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control form-control-sm input-edit" name="foto" type="file" id="formFile">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-11">
                                    <textarea required class="form-control input-edit" name="alamat" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                            </div>
