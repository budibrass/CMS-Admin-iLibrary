                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input required type="text" class="form-control form-control-sm input-add" name="nama_buku" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="text" class="form-control form-control-sm input-add" name="jenis" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="hidden" name="id">
                                            <input required type="text" class="form-control form-control-sm input-add" name="pengarang" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="text" class="form-control form-control-sm input-add" name="penerbit" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="hidden" name="id">
                                            <input required type="number" class="form-control form-control-sm input-add" name="stok_keseluruhan" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="number" class="form-control form-control-sm input-add" name="sisa_stok" id="exampleFormControlInput1">
                                        </div>
                                    </div>
                                </div>
                            </div>
